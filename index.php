...
<body style="background-image: url('images/fondo2.jpg'); background-size: cover; background-position: center;">
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow-lg" style="width: 100%; max-width: 400px;">
            <h2 class="text-center mb-4">Control APR <i class="fas fa-tint me-2" style="padding-right: 20px;color:#143D59;"></i></h2>
            <form id="loginForm">
                <div class="mb-3">
