                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="txt_numero" name="txt_numero" disabled required maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            <label for="txt_contacto2" class="form-label">Contacto 2</label>
                                            <input type="text" class="form-control" id="txt_contacto2" name="txt_contacto2" disabled required maxlength="20">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
